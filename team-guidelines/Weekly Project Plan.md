...
- The client confirms the final MVP scope.
- Written evidence of the client's MVP approval is obtained.
- Facilitator, client, and group meeting records are completed.
...
- [ ] Complete all four sections of the group report.
- [ ] Ensure that the report reflects the client-approved MVP.
- [ ] Include an acknowledgement explaining how AI was used.
- [ ] Review the report against the marking rubric.
- [ ] Combine, proofread, and convert the report into one PDF file.
- [ ] Submit the final PDF before the deadline.
